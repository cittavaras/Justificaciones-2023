...
i=0
conexion.commit
df = pd.read_excel('/root/Justificaciones2023-Produccion/Justificaciones-2023/cargasemestral/archivo-excel.xlsx') #Ubicación del archivo excel, lugar por defecto, se debe completar la dirección completa
